...
# Load Data
client = pd.read_csv("/home/firda_dellairawan/completedclient.csv")
card = pd.read_csv("/home/firda_dellairawan/completedcard.csv")
dacct = pd.read_csv("/home/firda_dellairawan/completedacct.csv")
loan = pd.read_csv("/home/firda_dellairawan/completedloan.csv")
poss = pd.read_csv("/home/firda_dellairawan/completeddisposition.csv")
distrik = pd.read_csv("/home/firda_dellairawan/completeddistrict.csv")
dl_merge = pd.merge(dacct,loan, on=["account_id", "year"])


###########################
st.header("Distribution age using Histogram")
x = (client["age"])
